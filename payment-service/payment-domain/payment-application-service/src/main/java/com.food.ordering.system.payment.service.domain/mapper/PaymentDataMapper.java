...
public class PaymentDataMapper {
    ...
    public Payment paymentRequestModelToPayment(PaymentRequest paymentRequest) {
        return Payment.builder()
                ...
                .sourceAccountId(new CustomerId(UUID.fromString(paymentRequest.getSourceAccountId())))
                .destinationAccountId(new CustomerId(UUID.fromString(paymentRequest.getDestinationAccountId())))
    ...
    public OrderEventPayload paymentEventToOrderEventPayload(PaymentEvent paymentEvent) {
        return OrderEventPayload.builder()
                ...
                .sourceAccountId(paymentEvent.getPayment().getSourceAccountId().getValue().toString())
                .destinationAccountId(paymentEvent.getPayment().getDestinationAccountId().getValue().toString())
