...
public class PaymentMessagingDataMapper {
    ...
    public PaymentRequest paymentRequestAvroModelToPaymentRequest(PaymentRequestAvroModel paymentRequestAvroModel) {
        return PaymentRequest.builder()
                ...
                .sourceAccountId(paymentRequestAvroModel.getSourceAccountId().toString())
                .destinationAccountId(paymentRequestAvroModel.getDestinationAccountId().toString())
    ...
    public PaymentResponseAvroModel orderEventPayloadToPaymentResponseAvroModel(String sagaId,
        ...
        return PaymentResponseAvroModel.newBuilder()
                ...
                .setSourceAccountId(UUID.fromString(orderEventPayload.getSourceAccountId()))
                .setDestinationAccountId(UUID.fromString(orderEventPayload.getDestinationAccountId()))
