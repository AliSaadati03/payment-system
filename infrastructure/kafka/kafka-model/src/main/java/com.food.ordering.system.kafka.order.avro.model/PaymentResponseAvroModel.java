...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   * @param destinationAccountId The new value for destinationAccountId
   */
  public PaymentResponseAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID paymentId, java.util.UUID sourceAccountId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createdAt, com.food.ordering.system.kafka.order.avro.model.PaymentStatus paymentStatus, java.util.List<java.lang.String> failureMessages, java.util.UUID destinationAccountId) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: sourceAccountId = (java.util.UUID)value$; break;
    ...
    case 9: destinationAccountId = (java.util.UUID)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @param value the value to set.
   */
  public void setSourceAccountId(java.util.UUID value) {
    this.sourceAccountId = value;
  }


    /**
     * Gets the value of the 'destinationAccountId' field.
     * @return The value of the 'destinationAccountId' field.
     */
    public java.util.UUID getDestinationAccountId() {
        return destinationAccountId;
    }


    /**
     * Sets the value of the 'destinationAccountId' field.
     * @param value the value to set.
     */
    public void setDestinationAccountId(java.util.UUID value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponseAvroModel>
    ...
    private Builder(com.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder other) {
      ...
      if (isValidValue(fields()[3], other.sourceAccountId)) {
        this.sourceAccountId = data().deepCopy(fields()[3].schema(), other.sourceAccountId);
      ...
      if (isValidValue(fields()[9], other.destinationAccountId)) {
            this.destinationAccountId = data().deepCopy(fields()[9].schema(), other.destinationAccountId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setSourceAccountId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearSourceAccountId() {
    ...
    public com.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearFailureMessages() {
      ...
      /**
       * Sets the value of the 'destinationAccountId' field.
       * @param value The value of 'destinationAccountId'.
       * @return This builder.
       */
      public com.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setDestinationAccountId(java.util.UUID value) {
      ...
      /**
       * Checks whether the 'destinationAccountId' field has been set.
       * @return True if the 'destinationAccountId' field has been set, false otherwise.
       */
      ...
      /**
       * Clears the value of the 'destinationAccountId' field.
       * @return This builder.
       */
      public com.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearDestinationAccountId() {
          sourceAccountId = null;
    ...
    public PaymentResponseAvroModel build() {
      try {
        ...
        record.sourceAccountId = fieldSetFlags()[3] ? this.sourceAccountId : (java.util.UUID) defaultValue(fields()[3]);
        ...
        record.destinationAccountId = fieldSetFlags()[9] ? this.destinationAccountId : (java.util.UUID) defaultValue(fields()[3]);
        return record;
