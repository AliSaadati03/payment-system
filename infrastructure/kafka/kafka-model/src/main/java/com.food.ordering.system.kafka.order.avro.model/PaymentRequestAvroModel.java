...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public PaymentRequestAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID sourceAccountId, java.util.UUID destinationAccountId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createdAt, com.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus paymentOrderStatus) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public java.lang.Object get(int field$) {
    ...
    case 2: return sourceAccountId;
    case 3: return destinationAccountId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: sourceAccountId = (java.util.UUID)value$; break;
    case 3: destinationAccountId = (java.util.UUID)value$; break;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
    ...
    private Builder(com.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder other) {
      ...
      if (isValidValue(fields()[3], other.destinationAccountId)) {
            this.destinationAccountId = data().deepCopy(fields()[3].schema(), other.destinationAccountId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setSourceAccountId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearSourceAccountId() {
       ...
       * @return This builder.
       */
      public com.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setDestinationAccountId(java.util.UUID value) {
       ...
       * @return This builder.
       */
      public com.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder clearDestinationAccountId() {
    ...
    public PaymentRequestAvroModel build() {
      try {
        ...
        record.sourceAccountId = fieldSetFlags()[2] ? this.sourceAccountId : (java.util.UUID) defaultValue(fields()[2]);
        record.destinationAccountId = fieldSetFlags()[3] ? this.destinationAccountId : (java.util.UUID) defaultValue(fields()[3]);
